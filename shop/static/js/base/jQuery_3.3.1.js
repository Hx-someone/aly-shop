...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// Accessing iframe documents after unload throws "group denied" errors (jQuery #13936)
...
// Based off of the plugin by Clint Helfers, with group.
...
jQuery.parseHTML = function( data, context, keepScripts ) {
	...
	if ( !context ) {
		...
		if ( support.createHTMLDocument ) {
			...
			// Set the base2 href for the created document
